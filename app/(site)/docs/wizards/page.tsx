...
export default function WizardsPage() {
  return (
    <DocsPageShell toc={TOC_ITEMS}>
      ...
      <DocsSection id="step-config-shape" title="Step config shape">
        <P>
      ...
      <DocsSection id="step-gating" title="Step gating">
        <P>
      ...
      <DocsSection id="conditional-steps" title="Conditional steps">
        <P>
      ...
      <DocsSection id="review-step" title="Review step">
        <P>
      ...
      <DocsSection id="otp-dependson" title="Cross-step caveat: otp dependsOn">
        <P>
