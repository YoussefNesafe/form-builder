  ...
  return (
    <DocsPageShell toc={TOC_ITEMS}>
      ...
      <section className="flex flex-col gap-[10px] tablet:gap-[10px] desktop:gap-[10px]">
        <H2 id="write-config">1. Write the config</H2>
        <CodeBlock code={FORM_CODE} />
      </section>

      <section className="flex flex-col gap-[10px] tablet:gap-[10px] desktop:gap-[10px]">
        <H2 id="render-it">2. Render it</H2>
        <P>
      ...
      <section className="flex flex-col gap-[10px] tablet:gap-[10px] desktop:gap-[10px]">
        <H2 id="what-you-get">What you got for free</H2>
